  ...
  return (
    <>
      <div className="hero-section w-full lg:gap-0 gap-4 h-screen flex flex-col-reverse lg:flex-row items-center pt-30 py-20 px-10 lg:px-20">
        ...
        <div className="content w-full h-[50%] lg:w-[50%] lg:h-full flex flex-col justify-center items-start gap-6">
        ...
        <div className="hero-pic flex justify-end items-end w-full h-[50%] lg:w-[50%] lg:h-full">
          <img
            className="w-full h-full -hue-rotate-[160deg] saturate-150 contrast-150 animate-wipeLeft object-contain lg:object-contain"
            src={"/hero-pic.png"}
            alt="hero image"
          />
        </div>
